...
@section('title', 'Edit Chatbot Script')
...
<div class="chatbot-page">
    <div class="chatbot-header">
        <div>
            <h1 class="chatbot-title">Edit Chatbot Script</h1>
            <div class="chatbot-subtitle">
                Update the keyword, response, or status of this chatbot script.
            </div>
        </div>
    </div>
    ...
    <div class="chatbot-card">
        ...
        <form method="POST" action="{{ route('admin.chatbot.update', $chatbotResponse) }}">
            @csrf
            @method('PUT')
            ...
            <div class="chatbot-form-grid">
                <div class="chatbot-field">
                    ...
                    <input
                        ...
                        name="keyword"
                        class="chatbot-input"
                        value="{{ old('keyword', $chatbotResponse->keyword) }}"
                ...
                <div class="chatbot-field">
                    ...
                    <textarea
                        ...
                        required
                    >{{ old('reply', $chatbotResponse->reply) }}</textarea>
                </div>

                <div class="chatbot-field" style="max-width: 240px;">
                    <label for="is_active">Status</label>
                    <select id="is_active" name="is_active" class="chatbot-select">
                        <option value="1" {{ old('is_active', $chatbotResponse->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ old('is_active', $chatbotResponse->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>

                <div class="chatbot-helper">
                    Make sure the keyword is clear and the reply is student-friendly.
                    Inactive scripts will not be used by the chatbot.
                </div>
